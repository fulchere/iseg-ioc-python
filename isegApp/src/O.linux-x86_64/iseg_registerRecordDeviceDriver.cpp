...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devFribDiagStdPuppetRunning, *pvar_dset_devBoSoft,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devFribDiagStdLocalCommit,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAoSoftCallback", "devAoStats", "devBiSoft", "devBiSoftRaw",
    ...
    "devCasterMBBIState", "devMbbiDirectSoft", "devMbbiDirectSoftRaw",
    ...
    "devSiGeneralTime", "devSiEnviron", "devFribDiagStdLocalCommit",
    "devStringinStats", "devStringinEnvVar", "devStringinEpics",
    "devCasterSIMsg", "devSoSoft", "devSoSoftCallback", "devSoStdio",
    "devSASoft", "devWfSoft", "devWaveformStats"
};
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_fribdiagstd_registrar, pvar_func_iocshSystemCommand,
    pvar_func_pySetupReg, pvar_func_reccasterRegistrar,
    pvar_func_retools_registrar, pvar_func_save_restoreRegister,
...
epicsShareExtern int * const pvar_int_reToolsVerbose;
...
static struct iocshVarDef vardefs[] = {
    ...
    {"reToolsVerbose", iocshArgInt, pvar_int_reToolsVerbose},
...
int iseg_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/fulcher/Desktop/iseg-ioc-python";
    ...
    pvar_func_pySetupReg();
    pvar_func_reccasterRegistrar();
    pvar_func_retools_registrar();
